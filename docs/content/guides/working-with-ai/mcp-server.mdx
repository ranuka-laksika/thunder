...
- Choose an authentication approach — see [Step 3](#step-3-add-mcp-server-to-vs-code) for detailed setup:
...
## Step 1: Add Certificate to System Certificates
